<div class="container">
	...
	{!! Form::open(array('url'=>'encuestaspy/participar','method'=>'POST', 'enctype' => 'multipart/form-data', 'autocomplete'=>'off','files'=>'true')) !!}
		...
		<div class="form-group">
			...
			<label class="contenedor">TAL VEZ
			  <input name="respuesta1" type="radio" value="3">
			  <span class="checkmark"></span>
			</label>
		</div>
		<div class="form-group">
			...
			<label class="contenedor">TAL VEZ
			  <input name="respuesta2" type="radio" value="3">
			  <span class="checkmark"></span>
			</label>
		</div>
		@if(!empty($pregunta->opcion3))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  <input name="respuesta3" type="radio" value="3">
				  <span class="checkmark"></span>
				</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion4))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  <input name="respuesta4" type="radio" value="3">
				  <span class="checkmark"></span>
				</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion5))
			<div class="form-group">
				<p>5- <strong>{{$pregunta->opcion5}}</strong> </p>
					...
					<label class="contenedor">TAL VEZ
					  <input name="respuesta5" type="radio" value="3">
					  <span class="checkmark"></span>
					</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion6))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  <input name="respuesta6" type="radio" value="3">
				  <span class="checkmark"></span>
				</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion7))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  <input name="respuesta7" type="radio" value="3">
				  <span class="checkmark"></span>
				</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion8))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  <input name="respuesta8" type="radio" value="3">
				  <span class="checkmark"></span>
				</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion9))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  <input name="respuesta9" type="radio" value="3">
				  <span class="checkmark"></span>
				</label>
			</div>
		@endif
		@if(!empty($pregunta->opcion10))
			<div class="form-group">
				...
				<label class="contenedor">TAL VEZ
				  	<input name="respuesta10" type="radio" value="3">
				  	<span class="checkmark"></span>
				</label>
			</div>
		@endif
